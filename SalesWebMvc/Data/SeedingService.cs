...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed() //operação responsável por popular a base de dados
        {
            if(_context.Department.Any() ||//Verifica se existe algum registro nas tabelas
                _context.Seller.Any() ||
            ...
            _context.Department.AddRange(d1, d2, d3, d4); //Permite adicionar vários objetos de uma vez
